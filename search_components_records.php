	...
	<div id="site_content">
      <div id="content">
        <div class="content_item">
          ...
          <form action="search_components_result.php" method="post">

            <div>
              <div style="width:150px; display:inline-block"><p>Component Name</p></div>
              <div style="width:430px; display:inline-block"><p><input class="contact" type="text" name="component_name" value=""/></p></div>
            </div>

            <div>
              <div style="width:150px; display:inline-block"><p>Component Part No.</p></div>
              <div style="width:140px; display:inline-block"><p><input class="contact" type="text" name="part_no" value=""/></p></div>
            </div>

            <div>
              <div style="width:150px; display:inline-block"><p>Component Alternate Part No.</p></div>
              <div style="width:430px; display:inline-block"><p><input class="contact" type="text" name="alternate_part_no" value="" /></p></div>
            </div>
