	  ...
	  <div id="content">
        <div class="content_item">
          <h2>Component Entry</h2>
            <p>Enter the data below regarding the Component</p>
            <form action="utility.php" method="post">
            	
            	<div>
            		<div style="width:150px; display:inline-block"><p>Component Name*</p></div>
            		<div style="width:430px; display:inline-block"><p><input class="contact" type="text" name="component_name" value="" required/></p></div>
            	</div>

            	<div>
            		<div style="width:150px; display:inline-block"><p>Component Part No.*</p></div>
            		<div style="width:430px; display:inline-block; vertical-align:top; padding-top:4px;"><p><input class="contact" type="text" name="part_no" value="" required/></p></div>
            	</div>

                <div>
                    <div style="width:150px; display:inline-block"><p>Component Alternate Part No.</p></div>
                    <div style="width:430px; display:inline-block; vertical-align:top; padding-top:4px;"><p><input class="contact" type="text" name="alternate_part_no" value="" /></p></div>
                </div>
	            ...
	            <div style="padding-left:150px;"><p style="padding-top: 15px"><input style="width:83px; height:27px;" class="submit" type="submit" name="component_data_submit" value="Submit" /></p></div>
	        </form>
